...
For example, you can use it to see the changes between a directory and its last backup, or to synchronize data directories between different machines

TODO: add screenshot

## Features

- interactive mode (TUI): browsable diff view in the terminal
...
- support local and remote folder (using SSH to run a local instance on the remote machine)
- synchronize folders by identifying and propagating changes
- use Blake3 hash algorithm to keep a signature of files for sync or for remote comparison
